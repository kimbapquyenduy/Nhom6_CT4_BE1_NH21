...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/cartcss.css" />
</head>
    ...
    <div class="main">
        ...
        <section class="shopping-cart">
          ...
          <div class="_column product-image">
            <img class="product-image--img" src="{{=D:\wamp\www\nhom6\img\206dfccd-fff6-4a68-a5bd-d35dfac74529.jpg}}" alt="Item image" />
          </div>
