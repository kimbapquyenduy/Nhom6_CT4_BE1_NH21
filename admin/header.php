        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        ?>
                        <li class="nav-item <?php echo ($page == "/nhom6/admin/index.php" ? "menu-open" : "") ?>">

                            <a href="index.php" class="nav-link  <?php echo ($page == "/nhom6/admin/index.php" ? "active" : "") ?>">
                        ...
                        <li class="nav-item <?php echo ($page == "/nhom6/admin/Products.php" ? "menu-open" : "") ?>">
                            <a href="Products.php" class="nav-link <?php echo ($page == "/nhom6/admin/Products.php" ? "active" : "") ?>">
                        ...
                        <li class="nav-item <?php echo ($page == "/nhom6/admin/Manufactures.php" ? "menu-open" : "") ?>">
                            <a href="Manufactures.php" class="nav-link <?php echo ($page == "/nhom6/admin/Manufactures.php" ? "active" : "") ?>">
                        ...
                        <li class="nav-item <?php echo ($page == "/nhom6/admin/Protypes.php" ? "menu-open" : "") ?>">
                            <a href="Protypes.php" class="nav-link <?php echo ($page == "/nhom6/admin/Protypes.php" ? "active" : "") ?>" style="a:hover ">
