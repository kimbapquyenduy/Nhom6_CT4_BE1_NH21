 <?php
    class Product extends Db
    {
        ...
        public function get3ProductsByManu($manu_id, $page, $perPage)
        {
            ...
            WHERE manu_id = ? and products.type_id=protypes.type_id  LIMIT ?,?");
        ...
        public function get3ProductsByPro($type_id, $page, $perPage)
        {
            // Tính số thứ tự trang bắt đầu
            $firstLink = ($page - 1) * $perPage;
            $sql = self::$connection->prepare("SELECT * FROM products
        ...
        public function getProductsByProtype($type_id)
        {
            // Tính số thứ tự trang bắt đầu
